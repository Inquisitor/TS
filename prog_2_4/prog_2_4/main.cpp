...
#include <string>
using namespace std;
const char *sign_zodiac[12] = {"Oven", "Telez", "Bliznezi", "Rak" , "Lev", "Deva",
                         "Vesy", "Scorpion", "Strelez", "Kozerog", "Vodoley", "Ryby" }; 
...
{
	out<<setw(20)<<setfill('.')<<setiosflags(ios::left)<<Znak.name<<Znak.zodiac<< Znak.bday[0]<<"."<<Znak.bday[1]<<"."<<Znak.bday[2]<<endl;
	return out;
}
